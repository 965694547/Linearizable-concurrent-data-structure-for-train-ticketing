...
public class Trace {
	final static int threadnum = 4; //线程总数 缺省为16
	final static int routenum = 3; // route is designed from 1 to 3 车次总数，缺省为5
	final static int coachnum = 5; // coach is arranged from 1 to 5 列车车厢数目，缺省为8
	final static int seatnum = 10; // seat is allocated from 1 to 20 每节车厢的座位数，缺省为8
	final static int stationnum = 8; // station is designed from 1 to 5 每个车次停站的数量，缺省为10

	final static int testnum = 1000; //测试总次数 用于输出乘客名称
